...
const services = [
  ...
  { icon: '/img/3f939c3223b1945290bbfd78ac10b303-removebg-preview.webp', title: 'Desarrollo de Experiencias Web UI', wrapClass: 'cardDarkGrid sec__2__card', flex: false },
      ...
      <div className="sec__2__flex__flexbox">
        ...
        <div className="cardDarkGrid sec__2__card">
          <div className="sec__2__card__ctn__img__tt">
            ...
            <h3>Desarrollo de Experiencias Web UI</h3>
            <a target="_blank" rel="noopener noreferrer" href="https://github.com/sebastianvasquezechavarria1234">
              Ir a Github
              <ArrowSvg />
            </a>
