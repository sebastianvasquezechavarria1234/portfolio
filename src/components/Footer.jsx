  ...
  <>
    ...
    <footer id="contacto">
      ...
      <div className="hero-social">
        <ul>
          <li>
            <a target="_blank" rel="noopener noreferrer" className="btn-footer" id="social-btn" href="https://github.com/sebastianvasquezechavarria1234">
          ...
          <li>
            <a target="_blank" rel="noopener noreferrer" className="btn-footer" id="social-btn" href="https://www.linkedin.com/in/sebastian-vasquez-echavarria-839923302/">
          ...
          <li>
            <a
              target="_blank" rel="noopener noreferrer" className="btn-click" id="social-btn"
          ...
          <li>
            <a target="_blank" rel="noopener noreferrer" className="btn-footer" id="social-btn" href="https://www.instagram.com/sebastianechavarria1314/">
          ...
          <li>
            <a target="_blank" rel="noopener noreferrer" className="btn-footer" id="social-btn" href="https://wa.me/573015857417">
              <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-whatsapp" width="32" height="32" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
