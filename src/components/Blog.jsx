  ...
  <section id="blog" className="blog">
    ...
    <div className="card-dark blog-card">
      ...
      <div className="blog-card-actions">
        ...
        <a className="blogBtn2" target="_blank" rel="noopener noreferrer" href="https://genesis-pixel.vercel.app/transitions/que-son">Empieza a aprender <span><ExternalLinkSvg /></span></a>
      </div>
    </div>
